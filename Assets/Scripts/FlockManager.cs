...
public class FlockManager : MonoBehaviour
{
    ...
    {
        if (bird.transform.position.x > 60f) bird.transform.position = new Vector3(-65f, bird.transform.position.y, 0f);
        if (bird.transform.position.x < -65f) bird.transform.position = new Vector3(60f, bird.transform.position.y, 0f);
        if (bird.transform.position.y > 35f) bird.transform.position = new Vector3(bird.transform.position.x, -60f, 0f);
        if (bird.transform.position.y < -60f) bird.transform.position = new Vector3(bird.transform.position.x, 35f, 0f);
    }
}